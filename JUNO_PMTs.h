...
class JUNO_PMTs {
    ...
    public : 
        ...
        ~JUNO_PMTs() = default;
        JUNO_PMTs(JUNO_PMTs const& other) = default;
		JUNO_PMTs(JUNO_PMTs && other) noexcept = default;
		JUNO_PMTs& operator=(JUNO_PMTs const& other) = default;
		JUNO_PMTs& operator=(JUNO_PMTs&& other) noexcept = default;
